...
export default function Project({
  ...
  return (
    <motion.section
      className="group relative mb-3 max-w-[42rem] overflow-hidden rounded-lg border border-black/5 bg-gray-100 transition last:mb-0 hover:bg-gray-200
       sm:mb-8 sm:h-[20rem] sm:pr-8 sm:group-even:pl-8"
      ref={ref}
      style={{
        scale: scaleProgess,
